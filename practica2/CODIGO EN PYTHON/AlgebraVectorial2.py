...
class AlgebraVectorial:
    ...
    def normalizar(self):
        ...
        return AlgebraVectorial(self.a1 / mag, self.a2 / mag, self.a3 / mag)
    # e)
    def producto_punto(self, otro):
        return self.a1 * otro.a1 + self.a2 * otro.a2 + self.a3 * otro.a3
    # f)
    def producto_cruz(self, otro):
        return AlgebraVectorial(self.a2 * otro.a3 - self.a3 * otro.a2, self.a3 * otro.a1 - self.a1 * otro.a3, self.a1 * otro.a2 - self.a2 * otro.a1)
...
print(f"{producto_esc}")
    
print("\nProducto vectorial:")
producto_vec=a.producto_cruz(b)
print(f"{producto_vec}")
    
print("\nParalelogramo:")
esrectangulo = a.verifica_paralelogramo_rectangulo(b)
print(f"Igualdad den las diagonales del parlelogramo: {esrectangulo}")
if esrectangulo:
