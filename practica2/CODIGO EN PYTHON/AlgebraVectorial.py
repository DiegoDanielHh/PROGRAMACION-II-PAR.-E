...
class AlgebraVectorial:
    ...
    def producto_cruz(self, otro):
        return AlgebraVectorial(self.y * otro.z - self.z * otro.y, self.z * otro.x - self.x * otro.z, self.x * otro.y - self.y * otro.x)
    # a)
    @multimethod
...
print(f"a es perpendicular a b (a): {a.es_perpendicular(b)}")
print(f"a es perpendicular a b (b): {a.es_perpendicular(b, 'b')}")
print(f"a es perpendicular a b (c): {a.es_perpendicular(b, 'c')}")
print(f"a es perpendicular a b (d): {a.es_perpendicular(b, 'd')}")

print("\nPARALELISM")
print(f"c es paralela a d (e): {c.es_paralela(d)}")
print(f"c es paralela a d (f): {c.es_paralela(d, 'f')}")

print("\nPROYECCIÓN Y COMPOENTE")
